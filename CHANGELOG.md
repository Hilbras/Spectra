...
### Changed
- Rewrote all documentation for production readiness
- Added API.md — full REST API reference
- Added PLUGIN_DEVELOPMENT.md — plugin development guide
- Fixed license to AGPL-3.0 across all files
- Fixed repository URLs to github.com/Hilbras/Spectra
